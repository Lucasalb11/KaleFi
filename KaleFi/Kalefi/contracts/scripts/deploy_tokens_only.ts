...
async function main() {
  ...
  try {
    ...
    if (existingKaleToken && existingUsdcToken) {
      ...
      console.log('');
      console.log('💡 Para fazer redeploy, remova os endereços do address book ou use:');
    ...
    console.error('1. Verifique se o Soroban está rodando: soroban config network ls');
