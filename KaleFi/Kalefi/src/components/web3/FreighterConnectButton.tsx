...
export const FreighterConnectButton: React.FC = () => {
  ...
  return (
    <div style={{ marginTop: 16, marginBottom: 16 }}>
      <button onClick={connectWallet} style={{ padding: '8px 16px', borderRadius: 6, background: '#2e3138', color: '#fff', border: 'none', cursor: 'pointer' }}>
        {publicKey ? 'Carteira conectada!' : 'Conectar carteira Stellar (Freighter)'}
      </button>
      {publicKey && (
