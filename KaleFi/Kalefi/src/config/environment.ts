export const env = {
  ...
  // Contract addresses
  kalefiContract:
    process.env.NEXT_PUBLIC_KALEFI_CONTRACT ??
    'CAPKM4UOBT7WDPOY3C6OLOOBTWRIZBYBHO4VVFCVM2YLJXVQRSU74NX6',
  kaleTokenContract:
    process.env.NEXT_PUBLIC_KALE_TOKEN_CONTRACT ??
    'CC627EWHGZZ3X4LFDRRUOMCOGUS6RPCLYJK24DKITA7H3KH7LMPEQ7EQ',
  usdcTokenContract:
    process.env.NEXT_PUBLIC_USDC_TOKEN_CONTRACT ??
    'CAADZAV7BPY6ADEUMO5QGFGXS22UQBBDBLLBDSZ3YBDQVCKODH6QQBE3',
